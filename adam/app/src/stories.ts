...
export const STORIES: Story[] = [
  {
    ...
    paragraphs: [
      ...
      'Când lui Adam i s-au închis ochișorii, luminița s-a așezat pe marginea ferestrei. Mama a șoptit „nani, bebe”, iar steaua a clipit o dată, ca și cum făcea „pa” și promitea că se întoarce și mâine.',
    ],
  },
  {
    id: 2,
    paragraphs: [
      ...
      'Când a venit vremea de nani, tata l-a învelit ușor pe Adam. Bulina s-a ridicat spre perdea, a clipit o dată, ca un „pa” mic, apoi a dispărut în lumina dimineții.',
    ],
  },
  {
    id: 3,
    paragraphs: [
      ...
      'Când a venit vremea de nani, tata a făcut „pa” cu mâna spre geam, iar mama l-a ținut pe Adam aproape. Bebe a închis ochișorii, iar apa din pahar a rămas acolo cuminte, păzind camera în tăcere.',
    ],
  },
  {
    id: 4,
    paragraphs: [
      ...
      'Când biberonul s-a golit, tata l-a ținut pe Adam la piept și i-a șoptit: „nani, bebe.” Lumina din cameră s-a făcut mică, ușa a făcut încet „pa”, iar Adam a adormit cu gust de lapte și liniște.',
    ],
  },
  {
    id: 5,
    paragraphs: [
      ...
      'Când ochișorii lui Adam s-au închis, tata a șoptit: „nani, bebe.” Lumina mică a făcut un ultim semn, ca un „pa”, apoi camera a rămas liniștită până dimineață.',
    ],
  },
]
